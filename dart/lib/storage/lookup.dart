...
class StorageLibrary {
  ...
  factory StorageLibrary.load({String? libraryPath}) => libraryPath != null
...
StorageLibrary loadBindingLibrary() {
  try {
    return StorageLibrary(
      Platform.isLinux ? DynamicLibrary.open(storageLibraryName) : throw UnsupportedError(Directory.current.path + slash + storageLibraryName),
      Directory.current.path + slash + storageLibraryName,
    );
  } on ArgumentError {
