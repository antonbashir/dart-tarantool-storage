...
- [API](#api)
  ...
  - [Schema - StorageSchema](#schema---storageschema)
  ...
  - [Space - StorageSpace](#space---storagespace)
    ...
    - [\[async\] `update()` - Updating space tuple by key with operations](#async-update---updating-space-tuple-by-key-with-operations)
...
- [Configuration](#configuration)
  ...
  - [StorageExecutorConfiguration](#storageexecutorconfiguration)
...
* `StorageExecutorConfiguration loop` - [See](#StorageExecutorConfiguration) 
...
* `double executorMaxSleepSeconds` - Max count of seconds for binding message loop idle sleeping time
* `int executorRingSize` - Internal ring buffer size for all messages between Dart and Tarantool
* `double executorRegularSleepSeconds` - Count of seconds for binding message loop idle sleeping time before count of empty cycles reached maximum
* `int executorMaxEmptyCycles` - Maximum of empty cycles
* `int executorEmptyCyclesMultiplier` - Multiplier for empty cycles
* `int executorInitialEmptyCycles` - Initial count for empty cycles
* `int executorRingRetryMaxCount` - Maximum retry count during tries of returing message into queue (used in concurrent transactions)
