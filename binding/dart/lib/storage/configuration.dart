...
class StorageConfiguration {
  ...
  int? get pidFile => _configurationMap[ConfigurationKeys.pidFile];
  ...
  int get replicationConnectTimeout => _configurationMap[ConfigurationKeys.replicationConnectTimeout];
