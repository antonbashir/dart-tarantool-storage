...
class StorageDefaults {
  ...
  static StorageBootConfiguration boot({bool? randomizeDelay}) => StorageBootConfiguration("replicator", "replicator", Duration(seconds: randomizeDelay == true ? Random().nextInt(10) + 5 : 0));
}
